...
**Deadline: August 15, 2026 at 23:59 UTC-3** (3 late days allowed with penalty)

---

## Context

Deploy the complete system to Google Kubernetes Engine with Terraform for infra.
